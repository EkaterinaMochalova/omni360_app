...
/// Причина отклонения показа с точки зрения того, что с ней делать дальше.
/// Проигрыш в аукционе — лишь одна из них, поэтому в интерфейсе всё вместе
/// называется «отклонённые показы», а «проигрыш» — только про ставку.
enum LossCategory {
